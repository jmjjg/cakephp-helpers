...
class ResultsSetHelperTest extends TestCase
{
    ...
    public function testIndex()
    {
        ...
        $expected = '<div class="index articles"><div class="paginator"><p>Page 1 out of 1, showing 1 records out of 1</p><ul class="pagination"><li class="first disabled"><a href="">&lt;&lt; first</a></li><li class="prev disabled"><a href="" onclick="return false;">&lt;&lt; Previous</a></li><li class="active"><a href="">1</a></li><li class="next disabled"><a href="" onclick="return false;">Next &gt;&gt;</a></li><li class="last disabled"><a href="">last &gt;&gt;</a></li></ul></div><table class="results_set"><thead><tr><th><a href="/?sort=id&amp;direction=asc">Id</a></th>
...
</tr></tbody></table><div class="paginator"><p>Page 1 out of 1, showing 1 records out of 1</p><ul class="pagination"><li class="first disabled"><a href="">&lt;&lt; first</a></li><li class="prev disabled"><a href="" onclick="return false;">&lt;&lt; Previous</a></li><li class="active"><a href="">1</a></li><li class="next disabled"><a href="" onclick="return false;">Next &gt;&gt;</a></li><li class="last disabled"><a href="">last &gt;&gt;</a></li></ul></div></div>';
